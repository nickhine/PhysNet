...
class InteractionLayer(NeuronLayer):
    ...
    def __init__(self, K, F, num_residual, activation_fn=None, seed=None, scope=None, keep_prob=1.0, dtype=tf.float32):
        ...
        with tf.variable_scope(scope):
            ...
            self._dense_i = DenseLayer(F, F, activation_fn, seed=seed, scope="dense_i", dtype=dtype) # central atoms
            self._dense_j = DenseLayer(F, F, activation_fn, seed=seed, scope="dense_j", dtype=dtype) # neighbouring atoms
